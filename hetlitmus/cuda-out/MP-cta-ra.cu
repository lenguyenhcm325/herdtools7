...
__global__ void litmus_MP_cta_ra(int* x, int* y, int* __out) {
  // ---- P0  (CTA 0, lane 0) ----
...
int main(void) {
  ...
  for (int it = 0; it < 100000; ++it) {
    *x = 0;
    *y = 0;
    litmus_MP_cta_ra<<<2, 1>>>(x, y, __out);
