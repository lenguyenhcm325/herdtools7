...
WHAT THIS GATE CHECKS.
  ...
  PHASE 1 -- SHAPE (all 338 emitted harnesses)
    ...
    the `_loc' witness.  Census 316 / 22.  This is the invariant the shipped code
    violated: an add inside the frame loop in a harness that has no per-frame
    observable at all.

  PHASE 2 -- DISPLAY (all 338)
...
N_WITH_LOC_COLUMN = 72      # 2+2W 22 + R 25 + S 25
