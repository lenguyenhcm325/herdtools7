...
printed `unknown oracle verdict "NO-ORACLE"' -- expected-nvidia.csv carries 74
such rows (42 until NVOR demoted 32 more on 2026-08-06), so the harness
misreported both shipped oracles.
