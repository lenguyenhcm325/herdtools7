...
names a canary for all 450 rows, and before B6c 320 of the then-338 named one they did not
...
THE ORACLE CLASS (B6c).  Without it het_verdict() framed all 450 tests as
...
prediction".  Only 53 of the 450 are Disallowed.  353 are oracle-ALLOWED -- there the
weak outcome is EXPECTED, and seeing it CONFIRMS the model is not over-strong -- and
44 are NO-ORACLE.  397 harnesses stand ready to print a LOUD FALSE REFUTATION of the
...
default N=100000 is 0 for ALL 450, while a T_L<=1 test decodes every frame exactly and
...
`REPORTING-TIER UPDATE' fixes the effective reporting tiers at ROBUST 322 /
ADVISORY 53 (S) / EXPLORATORY 75 (2+2W 22 + R 53).
