...
warning -- the shape a per-line grep of `fprintf(' lines cannot see:
  ...
  xc-planted/MP-cg-sys-relaxed-x86_64/MP-cg-sys-relaxed-x86_64.cu:751: names 'Grace' (the gh200 row's word; this lane is entitled to none): the Grace half is idle
