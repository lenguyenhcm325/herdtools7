...
//   P0: f[release,cluster]
//   P0: w[relaxed,cluster] y 1
//   P1: r[relaxed,cluster] r0 y
//   P1: f[acquire,cluster]
...
__global__ void litmus_MP_cluster(int* x, int* y, int* __out) {
  // ---- P0  (CTA 0, lane 0) ----
...
int main(void) {
  ...
  for (int it = 0; it < 100000; ++it) {
    *x = 0;
    *y = 0;
    litmus_MP_cluster<<<2, 1>>>(x, y, __out);
