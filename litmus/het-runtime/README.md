...
Design: `hetlitmus/docs/environment-design.md` "GPU stress".
...
sized:
`hetlitmus/docs/environment-design.md` "Rendezvous".
...
Design: `hetlitmus/docs/environment-design.md` "Reporting".
...
* `het_alloc_*` — the shared litmus vars + the rendezvous counter
  ...
  (`gd_alloc_dev`).
  Design: `hetlitmus/docs/environment-design.md` "Allocation".
* `het_noise_*` — the interconnect-stress buffer (`gd_alloc_noise` /
  `gd_free_noise`).  Design: `hetlitmus/docs/environment-design.md`
  "Interconnect stress".

They are per-dialect because the two targets differ in kind, not in spelling
(`hetlitmus/docs/environment-design.md` "Interconnect stress"): the CUDA
