...
#endif
#if (HET_RDV_POKE_EVERY & (HET_RDV_POKE_EVERY - 1)) != 0
#error "HET_RDV_POKE_EVERY must be a power of two"
#endif
...
/* The host half.  [_poke], when not NULL, runs once per HET_RDV_POKE_EVERY
   polls. */
